SpringBoot HelloWorld for App Engine Standard (Java 21)
============================

This sample demonstrates how to deploy a Java 21 Spring Boot application on
Google App Engine. The Java 21 App Engine runtime expects a
